  ...
  return (
    <>
      <div className="bg-emerald-500 dark:bg-emerald-700 mx-auto text-center rounded-3xl text-white max-w-xl mt-20">
        ...
        <br />
        <p className="text-white text-xl pb-3">Shuaib Rauph (srauph) - 40134457</p>
        <p className="text-white text-xl pb-3">Mahmoud Idlbi (Mah514) - 40016792</p>
        ...
        <p className="text-white text-xl pb-3">Ali Hanni (alimus22) - 40157164</p>
        <p className="text-white text-xl pb-3">
