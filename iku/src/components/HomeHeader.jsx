              ...
              <li class="w-96">
                <form>   
                  ...
                  <div class="relative">
                    ...
                    <input type="search" id="default-search" class="transition ease-in-out duration-200 block p-4 pl-10 w-full text-md font-semibold text-white placeholder-white bg-emerald-500 rounded-lg border-2 border-emerald-200 dark:border-emerald-300 focus:ring-green-300 dark:bg-emerald-700 dark:placeholder-emerald-100 dark:focus:ring-green-300" placeholder="Search Location" required/>
