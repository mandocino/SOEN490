...
//     test("Get address from coordinates (direct call)", async () => {
//         jest.mock("@googlemaps/google-maps-services-js");
//         const address = {
//             data: {address: '1455 Maisonneuve'}
//         }
//         jest.spyOn(geocodingClient, 'geocode').mockResolvedValueOnce(address);

//         const concordiaLatitude = 45.497109;
//         const concordiaLongitude = -73.578734; 
//         const mockReq = { query: {'lat': concordiaLatitude, 'lng': concordiaLongitude} };
...
//                 this.data = input;
//             }}
//         getAddressByCoordinates(mockReq, mockRes)
//         .then(response => {
...
//     test("Get coordinates from a valid address (direct call)", async () => {
//         jest.mock("@googlemaps/google-maps-services-js");
//         const coordinates = {
//             data: {coordinates: {'lat': 45.4948363, 'lng': -73.5779128}}
//         }
//         jest.spyOn(geocodingClient, 'geocode').mockResolvedValueOnce(coordinates);

//         const mockReq = { query: {'address': 'Concordia University, Boulevard de Maisonneuve Ouest' } };
//         const mockRes = { status: 0,
//             data: {},
//             json: function(input){
//                 this.status = 200;
//                 this.data = input;
//             }}
//         getCoordinatesByAddress(mockReq, mockRes)
//         .then(response => {
