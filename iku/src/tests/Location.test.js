...
describe("Google Geocoding API tests", () => {
    ...
    test("Get address from coordinates", async() => {
        ...
        const geocodedAddress = await axios.get('http://'+hostname+':5000/address/', {
            params:{
    ...
    test("Failed request for /address/", async () => {
        const response = await axios.get('http://'+hostname+':5000/address/', {
            params: null
        });
    ...
    test("Get coordinates from a valid address", async() => {
        ...
        const geocodedCoordinates = await axios.get('http://'+hostname+':5000/coordinates', {
            params: {
                address: address
            }
        });
    ...
    test("Failed request for /coordinates/", async () => {
        const response = await axios.get('http://'+hostname+':5000/coordinates', {
            params: {
                address: null
            }
        });
...
describe("Google Places Autocomplete API test", () => {
    ...
    test("Get suggestions for a given input", async () => {
        ...
        const suggestionsResponse = await axios.get('http://'+hostname+':5000/suggestions', {
            params: {
                input: input
            }
        });
    ...
    test("Failed request for /suggestions/", async () => {
        const response = await axios.get('http://'+hostname+':5000/suggestions', {
            params: {
                input: null
            }
        });
...
describe("Database tests", () => {
    ...
    test("Create", async () => {
        const resSignup = await axios.post(`http://${hostname}:5000/newlocation/`, {
    ...
    test("Create with invalid request", async () => {
        const response = await axios.post(`http://${hostname}:5000/newlocation/`, {
            user_id: null,
            latitude: 0,
            longitude: 0,
            name: "Fail Test",
    ...
    test("Get", async () => {
        const resGet = await axios.get(`http://${hostname}:5000/locations/${objectID}`);
    ...
    test("Modify", async () => {
        const resModify = await axios.post(`http://${hostname}:5000/updateLocation/`, {
            _id: locationID,
            name: "ModifiedTest"
        });
    ...
    test("Modify with invalid request", async () => {
        const response = await axios.post(`http://${hostname}:5000/updateLocation/`, {
            _id: 'badID',
            name: "ModifiedTest"
        });
    ...
    test("Delete", async () => {
        const resModify = await axios.post(`http://${hostname}:5000/deleteLocation/`, {
            _id: locationID
        });
        const resGet = await axios.get(`http://${hostname}:5000/locations/${objectID}`);
        expect(Array.isArray(resGet.data)).toBe(true);
    ...
    test("Delete with invalid request", async () => {
        const response = await axios.post(`http://${hostname}:5000/deleteLocation/`, {
            _id: 'badID'
        });
        expect(response.data.message).toContain("failed");
    });
